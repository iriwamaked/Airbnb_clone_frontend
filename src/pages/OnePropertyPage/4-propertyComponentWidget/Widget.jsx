  ...
  const handleBooking = () => {
    navigate("/checkout", {
      state: {
        ...
        rating: 4.95,
        reviews: 35,
        title: "Студія та спальня з панорамою моря! Аркадія!",
    ...
    <div className={styles["widget-container"]}>
      <div className={styles["custom-row"]}>
        ...
        <span className={styles["right-block"]}>
          <span><i className="bi bi-star-fill me-2"></i>4,95</span>
          <span className={styles['dot-divider']}></span>
          <span><span className={styles["underline-text"]}> 35 відгуків</span></span>
        </span>
      </div>
